...
@Component({
  ...
  styleUrl: './return-order-modal.component.scss'
})
export class ReturnOrderModalComponent {
  ...
  returnOrder() {
    ...
    this.orderService.returnOrder(this.orderId, formValues.Reason, formValues.RefundBalance)
      ...
      .subscribe({
        next: (response) => {
          ...
          this.toast.showSuccess('Order returned successfully');
